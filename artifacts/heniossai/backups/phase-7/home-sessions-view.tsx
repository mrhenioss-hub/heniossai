              ...
              <For each={props.groups()}>
                {(group, index) => (
                  <>
                    ...
                    />
                    <div
                      class={`flex min-w-0 flex-col gap-px ${index() === props.groups().length - 1 ? "pt-2" : "mb-4 pt-2"}`}
                    >
  ...
  return (
    <div class="w-full">
      <div ref={props.onSetSearchRoot} data-component="home-session-search" class="relative z-30 w-full">
        ...
        <label
          class={`
            relative z-20 flex h-7 w-full items-center gap-1.5 rounded-[4px] px-1.5
...
function HomeSessionSearchResultRow(
  ...
  return (
    <button
      ...
      class={`
        flex h-7 w-full shrink-0 cursor-default items-center gap-2 border-0 px-1.5 text-left
...
function HomeSessionRow(props: HomeSessionsViewProps & { record: HomeSessionRecord }) {
  ...
  return (
    <div
      class="group/session relative flex h-7 min-w-0 items-center rounded-[4px]"
    ...
    >
      <button
        ...
        class={`
          flex h-7 min-w-0 w-full flex-1 shrink-0 cursor-default items-center gap-1.5 rounded-[4px] border-0
          bg-transparent px-1.5 text-left text-v2-text-text-muted [font-weight:530]
  ...
  return (
    <div class="flex min-w-0 flex-col gap-4">
      ...
      <div class="flex min-w-0 flex-col gap-px" aria-hidden="true">
        <For each={[0, 1, 2, 3]}>{() => <div class="h-7 rounded-[4px] bg-v2-background-bg-deep opacity-70" />}</For>
      </div>
    </div>
  )
}
