...
const homeSessionIndexKey = (server: string) => ["home", "session-index", server] as const
const homeSessionEventsKey = (server: string) => ["home", "session-events", server] as const
