...
export function HomeProjectsView(props: HomeProjectsViewProps) {
  ...
  return (
    ...
    >
      ...
      <HomeUtilityNav
        class="mt-1 hidden shrink-0 lg:flex"
...
function HomeServerRow(props: {
  ...
  return (
    <div class="group/server relative flex h-7 min-w-0 items-center rounded-[4px]">
      <HomeProjectNavButton
        type="button"
...
function HomeProjectRow(
  ...
  return (
    <div
      ref={sortable.ref}
      class="group/project relative flex h-7 min-w-0 items-center rounded-[4px]"
...
function HomeProjectNavButton(props: JSX.ButtonHTMLAttributes<HTMLButtonElement>) {
  ...
  return (
    <button
      {...rest}
      class={`
        flex h-7 min-w-0 w-full shrink-0 cursor-default items-center gap-1.5 rounded-[4px] bg-transparent px-1.5 text-left
