...
export const dict = {
  ...
  "palette.search.placeholder.home": "SÃ¸k i kommandoer og sesjoner",
  ...
  "settings.general.row.colorScheme.description": "Velg om OpenCode skal fÃ¸lge systemets, lyst eller mÃ¸rkt tema",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) kreves fÃ¸r OpenCode kan legge til en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er utilgjengelig",
  "wsl.onboarding.wslUnavailable.description": "OpenCode kunne ikke bekrefte WSL pÃ¥ denne maskinen.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows pÃ¥ nytt for Ã¥ fullfÃ¸re installasjonen av WSL, og Ã¥pne deretter OpenCode pÃ¥ nytt.",
  ...
  "settings.general.row.newInterfaceNotice.title": "Du bruker nÃ¥ det nye oppsettet",
