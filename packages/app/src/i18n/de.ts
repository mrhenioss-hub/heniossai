...
export const dict = {
  ...
  "wsl.onboarding.checkingOpencode": "OpenCode wird geprÃ¼ft...",
  "wsl.onboarding.checkingOpencodeIn": "OpenCode in {{distro}} wird geprÃ¼ft...",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) ist erforderlich, bevor OpenCode einen WSL-Server hinzufÃ¼gen kann",
  "wsl.onboarding.wslUnavailable.title": "WSL nicht verfÃ¼gbar",
  "wsl.onboarding.wslUnavailable.description": "OpenCode konnte WSL auf diesem Computer nicht Ã¼berprÃ¼fen.",
  "wsl.onboarding.installWsl": "WSL installieren",
  "wsl.onboarding.windowsRestartRequired":
    "Starten Sie Windows neu, um die WSL-Installation abzuschlieÃŸen, und Ã¶ffnen Sie dann OpenCode erneut.",
  ...
  "settings.general.row.colorScheme.description":
    "WÃ¤hlen Sie, ob OpenCode dem System-, hellen oder dunklen Thema folgt",
  ...
  "settings.general.row.newInterface.description":
    "Verwenden Sie die neuen Tabs und das Startseitenlayout. FÃ¼r begrenzte Zeit kÃ¶nnen Sie zwischen den Layouts wechseln.",
  "settings.general.row.newInterfaceNotice.title": "Sie verwenden jetzt das neue Layout",
  "settings.general.row.newInterfaceNotice.description": "Das vorherige Layout ist nicht mehr verfÃ¼gbar",
